                        ...
                        {article.author.username === currentUser?.username && (
                          ...
                          >
                            <button
                              ...
                              className="text-xs border border-blue-400 text-blue-600 px-2 py-1 rounded hover:bg-blue-500 hover:text-white transition"
                            >
                              Edit
                            </button>
                            ...
                            <button
                              ...
                              className="text-xs border border-red-400 text-red-600 px-2 py-1 rounded hover:bg-red-500 hover:text-white transition"
                            >
                              Delete
                            </button>
                          </motion.div>
